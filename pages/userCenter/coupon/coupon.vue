<template>
	<view class="container">
		<!-- <show-empty-data v-if="{{couponList.length<=0}}" showType="NO_COUPON"></show-empty-data> -->
				...
				<view class="item" :style="{background: item.couponStatus==1?'linear-gradient(to right,#cfa568,#e3bf79)':'linear-gradient(to right,#999,#DDDDDD)'}">
					...
					<view class="content">
						...
						<view class="right">
							...
							<image v-if="item.couponStatus==2" class='mid-img' src='../../../static/images/coupon_ysy.png'></image>
							<image v-if="item.couponStatus==3" class='mid-img' src='../../../static/images/coupon_gq.png'></image>
						</view>
					</view>
