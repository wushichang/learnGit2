<template>
	...
	<view class="container">
		<view class="cus-list" v-if="whList.length > 0">
			<view class="cusBox" v-for="item in whList" :key="item.id">
...
<style>
	/* pages/customer/whlist/whlist.wxss */
	/* pages/customer/list/list.wxss */
	.search-header {
		position: fixed;
		top: 0;
		width: 750rpx;
	...
	.search-header .btnBox .commoncol {
		height: 58rpx;
		line-height: 58rpx;
		margin-left: 5%;
		margin-top: 16rpx;
	...
	.search-header .selValue .commoncol {
		width: 30%;
		height: 65rpx;
		line-height: 65rpx;
		margin-top: 28rpx;
	...
	.search-header .selValue button:nth-child(1) {
		margin-left: 0;
	}
