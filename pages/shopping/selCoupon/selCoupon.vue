	...
	<view class="container">
		...
		<view v-else class="coupon-list">
			<block v-for="(item,index) in couponList" :key="item.id">
				<view :data-item="item" @click='tapCoupon' class="item" :style="{background: item.couponStatus==1?'linear-gradient(to right,#cfa568,#e3bf79)':'linear-gradient(to right,#999,#DDDDDD)'}">
					<view class="content">
						<view class="left">
						...
						<view class="right">
							<image v-if="item.couponStatus==1" class='mid-img' src='../../../static/images/coupon_ksy.png'></image>
							<image v-if="item.couponStatus==3" class='mid-img' src='../../../static/images/coupon_bky.png'></image>
						</view>
					</view>
...
<script>
	...
	export default {
		...
		methods: {
			validCouponList(merchantId, goodsTotalPrice) {
